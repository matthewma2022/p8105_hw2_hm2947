...
-   There are a total number of 609 observations in the dataset. There
    are a total number of 28 variables in the dataset. The key
    variables’ names are dumpster.x, month.x, year.x, date.x,
    weight_tons, volume_cubic_yards.x, plastic_bottles.x, polystyrene.x,
    cigarette_butts.x, glass_bottles.x, grocery_bags.x, chip_bags.x,
    sports_balls, homes_powered.x, mrdf, dumpster.y, month.y, year.y,
    date.y, volume_cubic_yards.y, plastic_bottles.y, polystyrene.y,
    cigarette_butts.y, glass_bottles.y, grocery_bags.y, chip_bags.y,
    homes_powered.y, profdf
